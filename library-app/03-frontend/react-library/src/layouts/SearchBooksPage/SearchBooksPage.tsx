...
export const SearchBooksPage = () => {
  ...
  useEffect(() => {
    ...
    window.scrollTo(0, 0); // scroll to the top every time we call useEffect
  ...
  const categoryField = (value: string) => {
    ...
    switch (value) {
      case "fe":
        selectedValueLabel = "FE";
        break;
      case "be":
        selectedValueLabel = "BE";
        break;
      case "data":
        selectedValueLabel = "Data";
        break;
      case "devops":
        selectedValueLabel = "DevOps";
        break;
    }
    if (
      ...
      setCategorySelection(selectedValueLabel);
      setSearchUrl(`/search/findByCategory?category=${value}&page=<pageNumber>&size=${booksPerPage}`)
    } else {
      setCategorySelection(value.charAt(0).toUpperCase() + value.slice(1));
            ...
            <div className="col-4">
              <div className="dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                  ...
                  <li onClick={() => categoryField('fe')}><a href="#" className="dropdown-item">Front End</a></li>
                  <li onClick={() => categoryField('be')}><a href="#" className="dropdown-item">Back End</a></li>
